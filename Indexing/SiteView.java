...
public SiteView(File dir, String topDir){
                ...
                if (numrows > 0) {
                    for (int q = 1; q <= numrows; q++) {
                        ...
                        for (int q0 = 1; q0 < 5; q0++) {
                            ...
                            String dirltemp = ds[cc];
                            String href = dirout + "/" +dirltemp+"/index.html";
...
//	for (String v : ds ) buffy.append("<a href=\""+v+"/index.html\">"+v+"</a><p/>\n");
	 buffy.append("&nbsp;<p/><ol>\n");
	...
	buffy.append("<li><a href=\""+dirout+"/"+v+"\">"+v+"</a>");	
 	buffy.append("<p/></li>\n");
	...
	for (String v : ds ) new SiteView(new File(dir,v), topDir);
}catch(Exception ee){}
     }
...
public static void main(String[] args) throws Exception{
	...
	if(args.length==0){
		System.out.println("Usage: directory topDirectory");
		System.exit(0);
	}


	new SiteView(new File(args[0]), args[1]);
